...
# Canonical summary chain, shared with daily_full_run.sh: no deepseek-reasoner
# (cannot fit the SJTU token bucket), prism:gpt-5.5 as real cross-bucket fallback.
